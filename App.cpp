...
void App::preparePipelines() {
	...
	pipeline_info.renderPass = this->offscreen_render_pass;

	if (vkCreateGraphicsPipelines(this->device, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &this->offscreen_pipeline)) {
